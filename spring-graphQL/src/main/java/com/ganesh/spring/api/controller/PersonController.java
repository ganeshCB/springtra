package com.ganesh.spring.api.controller;
...
import com.ganesh.spring.api.dao.PersonRepository;
...
public class PersonController {
	...
	public String addPerson(@RequestBody List<Person>person) {
		repository.saveAll(person);
		return "record insearted : "+person.size();
